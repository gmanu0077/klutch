...
componentDidMount=async()=>{
  const data=  await axios.get('https://api.klutchh.in/v1/rosters/128622/129859?game_type=false');
            ...
            <div className="t2list">
                {this.state.roster2.map(player=>{
                    ...
                    return(
                        ...
                        <div className="container2"  onClick={()=>this.select(player.credit,player.name)}>
